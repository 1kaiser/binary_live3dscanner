 ...
 * (alt setting 0), like the HT-203U, InfiRay cores, and HIKMICRO-based devices.
 */
class BulkUvc(
    ...
    fun start(fd: FrameDesc): Boolean {
        ...
        log("bulkuvc: PROBE SET_CUR fmt=${fd.formatIndex} frm=${fd.frameIndex} (${fd.width}x${fd.height}) -> $r")
